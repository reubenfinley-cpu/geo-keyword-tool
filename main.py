...
def generate_prompts(req: GeneratePromptsRequest):
    system_lines = [
        ...
        "- IMPORTANT: At least 8 of the 30 prompts MUST reference AI, artificial intelligence, generative AI, or agentic tools — but the framing must match the journey stage. At awareness stage, AI references should only appear as vague curiosity or peer comparison (e.g. \"are other companies using some kind of automated system for this?\", \"is technology the answer here?\") — never as specific tool searches. At exploration stage, prompts can ask \"what AI tools exist for this?\". At evaluation and decision stages, prompts can compare platforms and ask about AI capabilities directly.",
