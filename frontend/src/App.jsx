  ...
  return (
    <div style={{ minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center" }}>
      <div style={{ width: 320, padding: "2rem", border: "0.5px solid #e0e0e0", borderRadius: 8 }}>
        <h1 style={{ fontSize: 18, fontWeight: 500, margin: "0 0 0.25rem" }}>Prompt Generation Agent</h1>
  ...
  return (
    <div style={{ maxWidth: 720, margin: "0 auto", padding: "2rem 1rem" }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: "2rem" }}>
        <div>
          <h1 style={{ fontSize: 20, fontWeight: 500, margin: 0 }}>Prompt Generation Agent</h1>
